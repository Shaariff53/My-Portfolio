...
export default function Galaxy({ className = '' }: GalaxyProps) {
  ...
  useEffect(() => {
    ...
    import('ogl').then(({ Renderer, Program, Mesh, Color, Triangle }) => {
      if (!ctn.isConnected) return;

      // Cap pixel ratio for performance (lower on mobile)
      ...
      let program: typeof Program.prototype;
      ...
      program = new Program(gl, {
        ...
        uniforms: {
          ...
          uDensity: { value: isMobile ? 0.5 : 0.8 },
          uHueShift: { value: 30 },
          uSpeed: { value: 0.3 },
